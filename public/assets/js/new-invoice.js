...
$('#addRow').click(function () {
    $('#itemsTable tbody').append(`
        <tr>
            ...
            <td><input type="number" name="items[${rowIndex}][quantity]" class="form-control form-control-sm quantity" required></td>
            <td><input type="number" name="items[${rowIndex}][unitPrice]" class="form-control form-control-sm unitPrice" required></td>
